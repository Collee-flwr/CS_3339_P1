...
void disassembleInstr(uint32_t pc, uint32_t instr) {
  ...
  switch(opcode) {
    ...
    case 0x04: cout << "beq " << regNames[rs] << ", " << regNames[rt] << ", " << hex << ((pc + 4) + (simm << 2)); break;
    case 0x05: cout << "bne " << regNames[rs] << ", " << regNames[rt] << ", " << hex << ((pc + 4) + (simm << 2)); break;
    case 0x09: cout << "addiu " << regNames[rt] << ", " << regNames[rs] << ", " << dec << simm; break;
    case 0xc: cout << "andi " << regNames[rt] << ", " << regNames [rs] << ", " << dec << uimm; break;
